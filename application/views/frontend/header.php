...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_instance()->config->base_url(); ?>static/frontend/css/css.css?v=2016010405">
    ...
    <script type="text/javascript" src="<?php echo get_instance()->config->base_url(); ?>static/frontend/js/js.js?v=201601031111003"></script>
</head>
<script>
    document_root = '/';
</script>
