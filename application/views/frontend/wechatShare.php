...
<input type="hidden" name="share_title" value="不期而遇美容">
<input type="hidden" name="share_link" value="<?php echo ShareUtil::getShareUrl(); ?>">
<input type="hidden" name="share_imgUrl" value="<?php echo UrlUtil::getBaseUrl(); ?>static/frontend/images/logo.png">
<input type="hidden" name="share_desc" value="不期而遇美容欢迎您">
