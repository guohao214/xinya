...
<div class="result-wrap">
    <div class="result-content">
        ...
        <?php echo form_open_multipart(RequestUtil::CM(array($exchangeGoods['exchange_goods_id'], $limit))); ?>
            ...
            <tr>
                ...
                <td>
                    <input class="common-text required" name="exchange_goods_name"
                           value="<?php echo $exchangeGoods['exchange_goods_name']; ?>" size="50" type="text">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <img class="project_cover"
                         src="<?php echo UploadUtil::buildUploadDocPath($exchangeGoods['exchange_goods_pic'], '200x200'); ?>">
                    <br>
            ...
            <tr>
                ...
                <td>
                    <select name="exchange_shop_id" class="required select">
                        <?php $this->load->view('backend/shop/shopList', array('selectShop' => $exchangeGoods['exchange_shop_id'], 'hideBelongAllShop' => 1)); ?>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input class="common-text required" name="exchange_credits"
                           value="<?php echo $exchangeGoods['exchange_credits']; ?>" size="20" type="text">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input class="common-text required" name="start_time" size="20"
                           value="<?php echo $exchangeGoods['start_time']; ?>" type="text">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input class="common-text required" name="expire_time"
                           value="<?php echo $exchangeGoods['expire_time']; ?>" size="20" type="text">
                </td>
            </tr>
