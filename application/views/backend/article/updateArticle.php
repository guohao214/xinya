...
<div class="result-wrap">
    <div class="result-content">
        ...
        <?php echo form_open(RequestUtil::CM(array('article_id' => $article['article_id']))); ?>
            ...
            <tr>
                ...
                <td>
                    <input class="common-text required" name="title"
                           value="<?php echo $article['title']; ?>" size="50" type="text">
                </td>
            </tr>
            <tr>
                <th><i class="require-red">*</i>别名：</th>
                <td><input class="common-text" value="<?php echo $article['alias_name']; ?>"
