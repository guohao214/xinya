        ...
        <table class="insert-tab" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input class="common-text required" name="coupon_name"
                           value="<?php echo set_value('coupon_name'); ?>" size="50" type="text">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input class="common-text required" name="counteract_amount"
                           value="<?php echo set_value('counteract_amount'); ?>" size="20" type="text">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input class="common-text required" name="use_rule"
                           value="<?php echo set_value('use_rule'); ?>" size="25" type="text">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn6" href="<?php echo UrlUtil::createBackendUrl('coupon/index'); ?>">返回</a>
                </td>
            </tr>
            </tbody>
        </table>
